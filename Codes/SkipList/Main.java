...
//        SkipList<Integer> myList = new SkipList<>(3);
        ...
        System.out.println(myList);
        System.out.println();
        System.out.println("searching for 0\t"+ myList.search(0).toString());            //first node search
        System.out.println("Searching for 8\t"+myList.search(8).toString());              //searching middle
        System.out.println("Searching for 2\t"+myList.search(2).toString());              //searching middle
        System.out.println("searching for 9\t"+myList.search(9).toString());            //last node search
